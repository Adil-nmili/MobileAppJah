  ...
  return (
    <ThemedView style={styles.container}>
      {caracteres.map((caractere) => (
        <ThemedView key={caractere.id} style={styles.caracterCard}>
          <Ionicons
            name={caractere.icon}
            size={40}
            style={styles.caracterIcon}
          />
          <ThemedText style={styles.caracterTitle}>{caractere.title}</ThemedText>
          <ThemedText style={styles.caracterDescription}>
